...
export interface KidsTextPlacement {
  ...
  /**
   * When true, the component renders text in a dedicated caption band that is
   * physically separate from the image window (KidsLetterboxCanvas) — the
   * image model does NOT need to reserve a clear region. Compose the scene
   * naturally with the subject fully visible.
   */
...
export const kidsComponentCapabilities: KidsComponentCapability[] = [
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, hook, title, and subtitle appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "A speech-bubble caption and label pill appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, context line, and question appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.67, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "A callout card with the fact appears in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.67, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, big number, and context appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.56, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, title, and step list appear in a dedicated caption BAND at the bottom of the frame (taller band for list content), physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.44, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The quotation mark, quote, and attribution appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.625, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, title, and ranked list appear in a dedicated caption BAND at the bottom of the frame (taller band for list content), physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.45, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The label pill, message, and encouragement appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the closing scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.67, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  },
  {
    ...
    textPlacement: {
      zone: "bottom",
      description: "The final question, subscribe CTA button, and channel name appear in a dedicated caption BAND at the bottom of the frame, physically separate from the image window. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.67, to: 1.0 },
      horizontalExtent: { from: 0.08, to: 0.92 },
      separateFromImage: true,
    },
  ...
  // region. This guarantees subtitles never overlap characters.
  {
    ...
    purpose: "A scene image in a dedicated window with the narration/caption in a translucent white speech bubble inside a TOP caption band (ambient blurred extension of the image). Text and image are physically separated — the subtitle can never overlap the subject.",
    ...
    textPlacement: {
      zone: "top",
      description: "The subtitle speech bubble appears in a dedicated caption BAND at the TOP of the frame (roughly the top 28%), physically separate from the image window below. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.0, to: 0.28 },
      horizontalExtent: { from: 0.10, to: 0.90 },
      separateFromImage: true,
    },
    selectionHint: "Use when the scene reads better with the caption on top (e.g. character looking up, tall subjects, sky compositions). Text never overlaps the image.",
    bestFor: ["Scenes where character looks upward", "Scenes with ground-level action", "Visual variety between scenes"],
    avoidWhen: "You want the standard caption position. Use kids-subtitle-bottom-scene instead.",
  },
  {
    slug: "kids-subtitle-bottom-scene",
    name: "Kids Subtitle Bottom Scene",
    purpose: "A scene image in a dedicated window with the narration/caption in a translucent white speech bubble inside a BOTTOM caption band (ambient blurred extension of the image, above the platform safe area). Text and image are physically separated — the subtitle can never overlap the subject.",
    narrativeRoles: ["image-reveal", "opening", "closing"],
    informationShapes: ["single-image", "fact-with-image"],
    tones: ["playful", "warm", "curious", "excited", "encouraging"],
    media: "required-image",
    ...
    textPlacement: {
      zone: "bottom",
      description: "The subtitle speech bubble appears in a dedicated caption BAND at the BOTTOM of the frame (roughly the bottom 33%), physically separate from the image window above. No region of the image needs to be kept clear — compose the scene naturally with the subject fully visible.",
      verticalExtent: { from: 0.67, to: 1.0 },
      horizontalExtent: { from: 0.10, to: 0.90 },
      separateFromImage: true,
    },
    selectionHint: "The standard caption position — use for most scenes. Text never overlaps the image.",
    bestFor: ["Most standard scenes", "Scenes where character is standing tall", "Scenes with sky/trees at top"],
    avoidWhen: "You want visual variety with the caption on top. Use kids-subtitle-top-scene instead.",
  },
];
...
export function textPlacementToNegativeHint(tp: KidsTextPlacement): string {
  // Letterboxed components keep text outside the image entirely — the negative
  // prompt only needs to guard against a cropped/edge-pressed subject.
  if (tp.separateFromImage) {
