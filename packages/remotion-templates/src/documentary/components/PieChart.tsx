...
export const PieChart: React.FC<Props> = ({ data, theme, delay = 5 }) => {
  ...
  return (
    <DocumentaryCanvas theme={theme} delay={delay} eyebrow="Share of the whole" icon={data.icon ?? "layers"} footer={`${total} total units`} contentStyle={{ justifyContent: "flex-start", paddingTop: 42 }}>
